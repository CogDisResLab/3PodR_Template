...
enricher_output_1 <- global_state$data %>%
...
knitr::asis_output(enricher_output_1)
```
...
enricher_output_2 <- list(ENRICHR_PAVER_result, "logCS") %>%
  knitr::knit_child(text = readLines(here::here("Rmd", "paver_report.Rmd")),
                    envir = environment(),
                    quiet = TRUE)

knitr::asis_output(enricher_output_2)
}, error = function(e) {
