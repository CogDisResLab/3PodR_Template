...
gsea_output_1 <- global_state$data %>%
...
knitr::asis_output(gsea_output_1)
``` 
...
gsea_output_3 <- list(GSEA_PAVER_result, "NES") %>%
  knitr::knit_child(text = readLines(here::here("Rmd", "paver_report.Rmd")),
                    envir = environment(),
                    quiet = TRUE)


knitr::asis_output(gsea_output_3)
}, error = function(e) {
